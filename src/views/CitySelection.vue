  ...
  <div class="container">
    ...
    <div v-if="fraudBehaviors.length > 0" class="scam-cards">
      <div class="prevention-banner">
        ...
        <a href="/avoid" class="prevention-link">Avoid and Prevent Tourist Scams</a>.
        </p>
      </div>
     ...
     <AffiliateCard
      link="https://expedia.com/affiliates/tourist_guards/fidelis30"
      title="Start Your Journey with Confidence"
      description="Travel without the fear of scams. Book your next trip with trusted partners who have your safety in mind."
      buttonText="Secure Your Trip Now"
    />
    </div>
  </div>
</template>
...
export default {
  ...
  watch: {
    ...
    const canonicalUrl = newCity
      ? `${window.location.origin}/scams/${newCity.toLowerCase().replace(/\s+/g, '-')}`
